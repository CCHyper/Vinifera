...
class DirectShowVideoPlayer
{
    public:
        ...
        BOOL Is_File_Available(const char *pszFileName, Wstring *dest = nullptr);
        ...
        Wstring Get_Filename() const { return Filename; }
        Wstring Get_Filename_NoExt() const { return FilenameNoExt; }
