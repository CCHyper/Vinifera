...
bool DirectSoundAudioDriver::Is_Handle_Looping(AudioHandle handle) const
{
    ASSERT(DirectSoundAudio != nullptr);
...
bool DirectSoundAudioDriver::Pause_Handle(AudioHandle handle)
{
    ASSERT(DirectSoundAudio != nullptr);
...
bool DirectSoundAudioDriver::Resume_Handle(AudioHandle handle)
{
    ASSERT(DirectSoundAudio != nullptr);
