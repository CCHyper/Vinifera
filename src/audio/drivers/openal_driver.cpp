...
void OpenALAudioDriver::Stop_Handle_Playing(AudioHandle handle)
{
    ...
    if (!Is_Available()) {
        DEV_DEBUG_WARNING("OpenAL: Driver is unavailable when calling Stop_Sample()!\n");
        return;
    }
...
bool OpenALAudioDriver::Is_Handle_Playing(AudioHandle handle) const
{
    ...
    if (!Is_Available()) {
        DEV_DEBUG_WARNING("OpenAL: Driver is unavailable when calling Sample_Status()!\n");
        return false;
    }
...
{
    if (!Is_Available()) {
        DEV_DEBUG_WARNING("OpenAL: Driver is unavailable when calling Is_Sample_Playing()!\n");
        return false;
    }
...
#if 0
    if (!Is_Available()) {
        DEV_DEBUG_WARNING("OpenAL: Driver is unavailable when calling Play_Sample()!\n");
...
#if 0
    if (!Is_Available()) {
        DEV_DEBUG_WARNING("OpenAL: Driver is unavailable when calling File_Play_Sample()!\n");
        return INVALID_AUDIO_HANDLE;
    }
...
void OpenALAudioDriver::Fade_Sample(AudioHandle handle, int ticks)
{
    ...
    if (!Is_Available()) {
        DEV_DEBUG_WARNING("OpenAL: Driver is unavailable when calling Fade_Sample()!\n");
        return;
    }
...
#if 0
    if (!Is_Available()) {
        DEV_DEBUG_WARNING("OpenAL: Driver is unavailable when calling Get_Playing_Sample_Handle()!\n");
        return INVALID_AUDIO_HANDLE;
    }
...
void OpenALAudioDriver::Set_Handle_Loop(AudioHandle handle, bool loop)
{
    ...
    if (!Is_Available()) {
        DEV_DEBUG_WARNING("OpenAL: Driver is unavailable when calling Set_Handle_Loop()!\n");
        return;
    }
...
void OpenALAudioDriver::Set_Score_Handle_Pause(AudioHandle handle)
{
    ...
    if (!Is_Available()) {
        DEV_DEBUG_WARNING("OpenAL: Driver is unavailable when calling Set_Score_Handle_Pause()!\n");
        return;
    }
...
void OpenALAudioDriver::Set_Score_Handle_Resume(AudioHandle handle)
{
    ...
    if (!Is_Available()) {
        DEV_DEBUG_WARNING("OpenAL: Driver is unavailable when calling Set_Score_Handle_Resume()!\n");
        return;
    }
...
void OpenALAudioDriver::Set_Handle_Pitch(AudioHandle handle, float pitch)
{
    ...
    if (!Is_Available()) {
        DEV_DEBUG_WARNING("OpenAL: Driver is unavailable when calling Set_Handle_Pitch()!\n");
        return;
    }
...
#if 0
    if (!Is_Available()) {
        DEV_DEBUG_WARNING("OpenAL: Driver is unavailable when calling Set_Handle_Pan()!\n");
        return;
    }
...
#if 0
    if (!Is_Available()) {
        DEV_DEBUG_WARNING("OpenAL: Driver is unavailable when calling Set_Sample_Pan()!\n");
        return;
    }
...
void OpenALAudioDriver::Set_Handle_Volume(AudioHandle handle, int volume)
{
    ...
    if (!Is_Available()) {
        DEV_DEBUG_WARNING("OpenAL: Driver is unavailable when calling Set_Handle_Volume()!\n");
        return;
    }
...
#if 0
    if (!Is_Available()) {
        DEV_DEBUG_WARNING("OpenAL: Driver is unavailable when calling Set_Sample_Volume()!\n");
        return;
    }
...
int OpenALAudioDriver::Set_Sound_Volume(int volume)
{
    ...
    for (int index = 0; index < SampleTracker.Count(); ++index) {
        ...
        alCall(alSourcef(st->Source, AL_GAIN, (SoundVolume * st->Volume)));
    }
...
int OpenALAudioDriver::Set_Score_Volume(int volume)
{
    ...
    for (int index = 0; index < SampleTracker.Count(); ++index) {
        ...
        alCall(alSourcef(st->Source, AL_GAIN, (ScoreVolume * st->Volume)));
    }
    ...
    for (int i = 0; i < SampleTracker.Count(); ++i) {
        ...
        if (st->IsActive && st->Reducer > 0.0f && st->Volume > 0.0f) {
            ...
            if (!st->IsScore) {
                ...
                alSourcef(st->Source, AL_GAIN, (ScoreVolume * st->Volume));
            }
        }
    }
#endif
...
{
    if (!Is_Available()) {
        DEV_DEBUG_WARNING("OpenAL: Driver is unavailable when calling Sound_Callback()!\n");
        return;
    }
...
AudioHandle OpenALAudioDriver::Play_Sample_Handle(AudioSample sample, int priority, int volume, AudioHandle handle)
{
    ...
    if (!Is_Available()) {
        DEV_DEBUG_WARNING("OpenAL: Driver is unavailable when calling Play_Sample_Handle()!\n");
        return INVALID_AUDIO_HANDLE;
    }
...
AudioHandle OpenALAudioDriver::Stream_Sample_Callback(void *buffer, int size, bool (*callbackptr)(short, short *, void **, int *), int volume, AudioHandle handle)
{
    ...
    if (!Is_Available()) {
        DEV_DEBUG_WARNING("OpenAL: Driver is unavailable when calling Stream_Sample_Vol()!\n");
        return INVALID_AUDIO_HANDLE;
    }
