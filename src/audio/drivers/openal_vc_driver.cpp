...
bool OpenAL_VC_AudioDriver::Is_Handle_Looping(AudioHandle handle) const
{
    return false;
}
...
bool OpenAL_VC_AudioDriver::Pause_Handle(AudioHandle handle)
{
    return false;
}

bool OpenAL_VC_AudioDriver::Resume_Handle(AudioHandle handle)
{
    return false;
}
