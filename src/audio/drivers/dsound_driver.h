 ...
 *  @author        CCHyper
 *
 *  @brief         Installable DirectSound audio driver.
 *
...
/**
 *  This driver is just a wrapper around the original games audio engine.
 */
class DirectSoundAudioDriver : public AudioDriver
{
    public:
        ...
        virtual bool Pause_Handle(AudioHandle handle) override;
        virtual bool Resume_Handle(AudioHandle handle) override;
        ...
        virtual bool Is_Handle_Looping(AudioHandle handle) const override;
