...
void (*AudioDriver::FocusLossFunction)() = nullptr;
//bool AudioDriver::StreamLowImpact = false;
float AudioDriver::MasterVolume = 1.0f;
bool AudioDriver::IsReverseChannels = false;
int AudioDriver::MaxSampleTrackers = 16;
