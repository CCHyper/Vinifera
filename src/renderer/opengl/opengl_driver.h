...
class OpenGLVideoDriver : public VideoDriver
{
    ...
    private:
        static void __cdecl Window_Size_Callback(GLFWwindow *window, int width, int height);
        ...
        static void __cdecl Window_Key_Callback(GLFWwindow *window, int key, int scancode, int action, int mode);
