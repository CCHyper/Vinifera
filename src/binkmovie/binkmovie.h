...
class BinkMoviePlayer
{
    public:
        BinkMoviePlayer();
        BinkMoviePlayer(const Wstring &filename, bool can_be_stretched = true);
        //BinkMoviePlayer(const Wstring &filename, Surface *surface, bool can_be_stretched = true);
        ~BinkMoviePlayer();
        ...
        const Wstring Get_Filename() const { return Filename; }

        static float Set_Master_Volume(float vol);
        static void Set_Search_Path(const Wstring &dir_name);
        static const Wstring Get_Search_Path() { return BinkSearchPath; }
