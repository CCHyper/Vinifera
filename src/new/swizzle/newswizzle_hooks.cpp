...
void __cdecl SwizzleManagerClassExt_atexit() { reinterpret_cast<SwizzleManagerClassExt &>(SwizzleManager).~SwizzleManagerClassExt(); }
void __cdecl SwizzleManagerClassExt_dyn_init() { new (&SwizzleManager) SwizzleManagerClassExt; std::atexit(SwizzleManagerClassExt_atexit); }
