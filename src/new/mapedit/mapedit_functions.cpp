...
static void Toggle_Tactical_View(bool flag)
{
    if (flag) {
        ...
        Rect hidden(0, 0, Options.ScreenWidth-SidebarRect.Width, Options.ScreenHeight);
        Rect comp(0, 0, Options.ScreenWidth, Options.ScreenHeight);
        Rect tile(0, 0, Options.ScreenWidth, Options.ScreenHeight);
        Rect sidebar(0, 0, SidebarRect.Width, Options.ScreenHeight);
        ...
        Rect hidden(0, 0, Options.ScreenWidth-SidebarRect.Width, Options.ScreenHeight);
        Rect comp(0, 0, Options.ScreenWidth-SidebarRect.Width, Options.ScreenHeight);
        Rect tile(0, 0, Options.ScreenWidth-SidebarRect.Width, Options.ScreenHeight);
        Rect sidebar(0, 0, SidebarRect.Width, Options.ScreenHeight);
        Allocate_Surfaces(&hidden, &comp, &tile, &sidebar);

        Rect view(0, TacticalRect.Y, Options.ScreenWidth-SidebarRect.Width, Options.ScreenHeight-TacticalRect.Y);
        Map.Set_View_Dimensions(view);
