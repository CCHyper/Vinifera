 ...
 *  @author: CCHyper
 */
static void New_RulesClass_Extension(RulesClass *this_ptr)
{
    /**
 ...
 *  @author: CCHyper
 */
static void Delete_RulesClass_Extension()
{
    delete RulesExtension;
}
...
DECLARE_PATCH(_RulesClass_Constructor_Patch)
{
     ...
     */
    New_RulesClass_Extension(this_ptr);
    if (!RulesExtension) {
...
/**
 *  Patch for including the extended class during the initialisation process.
 * 
 *  @warning: Do not touch this unless you know what you are doing!
 * 
 *  @author: CCHyper
...
DECLARE_PATCH(_RulesClass_Initialize_Patch)
{
    ...
    GET_STACK_STATIC(CCINIClass *, ini, esp, 0x144);

    /**
     *  Call the extended class initialisation routine.
     */
    if (RulesExtension) {
...
/**
 *  Patch for including the extended class when processing rules data.
 * 
 *  @warning: Do not touch this unless you know what you are doing!
 * 
 *  @author: CCHyper
...
DECLARE_PATCH(_RulesClass_Process_Patch)
{
    ...
    /**
     *  Call the extended class process routine.
     */
    if (RulesExtension) {
