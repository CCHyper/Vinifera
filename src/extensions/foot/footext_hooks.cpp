...
void FootClassExt::_Draw_NavComQueue_Lines() const
{
     ...
     */
    bool is_dashed = RulesClassExtension::UIControls.IsMovementLineDashed;
    bool is_thick = RulesClassExtension::UIControls.IsMovementLineThick;
    bool is_dropshadow = RulesClassExtension::UIControls.IsMovementLineDropShadow;
...
void FootClassExt::_Draw_Action_Line() const
{
    ...
    bool is_show_navcom_queue_lines = RulesClassExtension::UIControls.IsShowNavComQueueLines;
