...
/**
 *  Reimplementation of FootClass::Draw_NavComQueue_Lines().
 * 
 *  @author: CCHyper
 */
void FootClassExt::_Draw_NavComQueue_Lines() const
{
     ...
     */
    bool is_dashed = UIControls->IsMovementLineDashed;
    bool is_thick = UIControls->IsMovementLineThick;
    bool is_dropshadow = UIControls->IsMovementLineDropShadow;

    unsigned line_color = DSurface::RGB_To_Pixel(
...
void FootClassExt::_Draw_Action_Line() const
{
     ...
     *  Fetch the line properties.
     */
    bool is_dashed = TarCom ? UIControls->IsTargetLineDashed : UIControls->IsMovementLineDashed;
    bool is_thick = TarCom ? UIControls->IsTargetLineThick : UIControls->IsMovementLineThick;
    bool is_dropshadow = TarCom ? UIControls->IsTargetLineDropShadow : UIControls->IsMovementLineDropShadow;
    ...
    bool is_show_navcom_queue_lines = UIControls->IsShowNavComQueueLines;
