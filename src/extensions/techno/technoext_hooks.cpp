...
void TechnoClassExt::_Draw_Target_Laser() const
{
     ...
     */
    bool is_dashed = TarCom ? UIControls->IsTargetLaserDashed : UIControls->IsMovementLineDashed;
    bool is_thick = TarCom ? UIControls->IsTargetLaserThick : UIControls->IsMovementLineThick;
    bool is_dropshadow = TarCom ? UIControls->IsTargetLaserDropShadow : UIControls->IsMovementLineDropShadow;
