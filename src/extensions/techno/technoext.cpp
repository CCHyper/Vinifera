...
{
    //EXT_DEBUG_TRACE("TechnoClassExtension NoInit constructor - Name: %s (0x%08X)\n", Name(), (uintptr_t)(This()));
}
...
void TechnoClassExtension::Response_Capture()
{
    ...
    const TechnoTypeClassExtension *technotypeext = Fetch_Extension<TechnoTypeClassExtension>(technotype);
