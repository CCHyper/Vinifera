 ...
 */
class SpawnReinforcementsCommandClass : public ViniferaCommandClass
{
    public:
        SpawnReinforcementsCommandClass() : ViniferaCommandClass() { IsDeveloper = true; }
        virtual ~SpawnReinforcementsCommandClass() {}
