 ...
 *  Print CRC's
 */
class SaveFullMapPreviewCommandClass : public ViniferaCommandClass
{
    public:
        SaveFullMapPreviewCommandClass() : ViniferaCommandClass() { IsDeveloper = true; }
        virtual ~SaveFullMapPreviewCommandClass() {}
