 ...
 */
class CycleHouseCommandClass : public ViniferaCommandClass
{
    public:
        CycleHouseCommandClass() : ViniferaCommandClass() { IsDeveloper = true; }
        virtual ~CycleHouseCommandClass() {}
...
class TogglePlaceAnywhereCommandClass : public ViniferaCommandClass
{
    public:
        TogglePlaceAnywhereCommandClass() : ViniferaCommandClass() { IsDeveloper = true; }
        virtual ~TogglePlaceAnywhereCommandClass() {}
