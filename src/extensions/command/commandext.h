 ...
 *  x
 */
class PlayPauseThemeCommandClass : public ViniferaCommandClass
{
    public:
        PlayPauseThemeCommandClass() : ViniferaCommandClass() { IsDeveloper = false; }
        virtual ~PlayPauseThemeCommandClass() {}
        ...
        virtual KeyNumType Default_Key() const override { return KeyNumType(KN_EQUAL); }
};
