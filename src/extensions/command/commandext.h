 ...
 */
class ToggleMissionCommandClass : public ViniferaCommandClass
{
    public:
        ToggleMissionCommandClass() : ViniferaCommandClass() { IsDeveloper = true; }
        virtual ~ToggleMissionCommandClass() {}
