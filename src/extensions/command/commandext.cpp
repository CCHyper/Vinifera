...
bool SpawnReinforcementsCommandClass::Process()
{
    ...
    New_Create_Air_Reinforcement(PlayerPtr, AircraftTypeClass::From_Name("ORCATRAN"), 1, MISSION_PARADROP_APPROACH, tarcom, navcom, InfantryTypeClass::From_Name("E1"), 5);
