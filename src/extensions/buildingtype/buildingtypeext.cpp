...
bool BuildingTypeClassExtension::Read_INI(CCINIClass &ini)
{
    ...
    IsSpySat = ini.Get_Bool(ini_name, "SpySat", IsSpySat);
    SpySatActivationSound = ini.Get_VocType(ini_name, "SpySatActivationSound", SpySatActivationSound);
    SpySatDeactivationSound = ini.Get_VocType(ini_name, "SpySatDeactivationSound", SpySatDeactivationSound);
