...
static void Play_Intro_SneakPeak_Movies()
{
    if (Vinifera_DeveloperMode && Movies.Count()) {
        ...
        /**
         *  If developer mode is active, then the "Intro / Sneak Peak" button
         *  on the main menu allows us to cycle through all the defines movies
         *  in the game.
         */
        ...
        /**
         *  Play the "Making Of" movie from Dune2000.
         */
        DEBUG_INFO("About to play MAKINGOF.VQA.\n");
        Vinifera_Play_Movie("MAKINGOF.VQA");
