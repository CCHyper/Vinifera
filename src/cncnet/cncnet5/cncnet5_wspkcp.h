 ...
 */
class CnCNet5KCPInterfaceClass : public UDPInterfaceClass
{
    public:
        CnCNet5KCPInterfaceClass(unsigned short id, unsigned long ip, unsigned short port, bool port_hack = false, int kcp_session_num = -1);
        virtual ~CnCNet5KCPInterfaceClass() {}
