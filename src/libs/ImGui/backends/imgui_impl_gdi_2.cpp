...
void ImGui_ImplGDI_2_Shutdown()
{
    
}

void ImGui_ImplGDI_2_NewFrame()
{
    ImGuiIO& io = ImGui::GetIO();
...
void ImGui_ImplGDI_2_SetBackgroundColor(ImVec4* BackgroundColor)
{
...
void ImGui_ImplGDI_2_RenderDrawData(ImDrawData* draw_data)
{
