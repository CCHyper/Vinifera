...
#define MISSION_PARADROP_APPROACH MissionType(MISSION_PATROL+1)
#define MISSION_PARADROP_OVERFLY MissionType(MISSION_PATROL+2)
#define MISSION_SPYPLANE_APPROACH MissionType(MISSION_PATROL+3)
#define MISSION_SPYPLANE_OVERFLY MissionType(MISSION_PATROL+4)
