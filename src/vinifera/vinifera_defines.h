 ...
 *  x
 */
typedef enum BPCTranslucentType
{
    CURSOR_TRANSLUCENT_NONE,
    CURSOR_TRANSLUCENT_25,
    CURSOR_TRANSLUCENT_50,
    CURSOR_TRANSLUCENT_75,

    CURSOR_TRANSLUCENT_NOT_SET = -1, // Special case for the BuildingType override.
} BPCTranslucentType;
