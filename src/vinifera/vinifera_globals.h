...
/**
 *  The new networking event queues.
 *   - OutList = Events generated by this player.
 *   - DoList = The list of events to execute.
 */
#define VINIFERA_MAX_EVENTS 256 // was 64, see MAX_EVENTS in TS++.
extern QueueClass<EventClass, VINIFERA_MAX_EVENTS> ViniferaOutList;
extern QueueClass<EventClass, (VINIFERA_MAX_EVENTS * 64)> ViniferaDoList;
