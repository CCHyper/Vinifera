...
void Vinifera_Swizzle_Reset(const char *file, const int line, const char *func)
{
    ...
    ViniferaSwizzleManager.ViniferaSwizzleManagerClass::Reset();
#else
...
void Vinifera_Swizzle_Request_Pointer_Remap(void **pointer, const char *file, const int line, const char *func, const char *var)
{
    ...
    funcname += "()";
    ViniferaSwizzleManager.ViniferaSwizzleManagerClass::Swizzle_Dbg(pointer, file, line, funcname.Peek_Buffer(), var);
#else
...
{
#ifdef VINIFERA_USE_NEW_SWIZZLE_MANAGER
    ViniferaSwizzleManager.ViniferaSwizzleManagerClass::Fetch_Swizzle_ID_Dbg(pointer, id, file, line, func, var);
#else
...
{
#ifdef VINIFERA_USE_NEW_SWIZZLE_MANAGER
    ViniferaSwizzleManager.ViniferaSwizzleManagerClass::Here_I_Am_Dbg(id, pointer, file, line, func, var);
#else
