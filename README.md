<p align="center" style="font-size:32pt;font-style:bold">
  <img src="docs/images/vinifera_logo.png" width=750>
</p>
...
<p align="center">
  <a href="https://github.com/vinifera-Developers/Vinifera/actions" target="_blank"><img alt="GitHub Workflow Status (develop)" src="https://img.shields.io/github/workflow/status/Vinifera-Developers/Vinifera/Nightly Build/develop?style=flat-square"></a> 
  <a href="https://vinifera.readthedocs.io/en/latest/" target="_blank"><img alt="Read The Docs Status" src="https://readthedocs.org/projects/vinifera/badge/?version=latest&style=flat-square"></a> 
  <a href="https://www.gnu.org/licenses/gpl-3.0.en.html" target="_blank"><img alt="GitHub" src="https://img.shields.io/github/license/Vinifera-Developers/Vinifera?style=flat-square"></a>
  <br>
  <b>Latest Stable Release</b>: <a href="https://github.com/Vinifera-Developers/Vinifera/releases" target="_blank">Download</a> 
  <br>
  <b>Latest Development Build</b>: <a href="https://nightly.link/Vinifera-Developers/Vinifera/blob/develop/.github/workflows/nightly.yml" target="_blank">Download</a> 
  <br>
  <b>Latest Documentation</b>: <a href="https://vinifera.readthedocs.io/en/latest/" target="_blank">Online</a>
</p>
...
# Usage
If you wish to use Vinifera in a public project, we kindly ask that you show support and feature one of the following logos on the main menu and/or any websites;

Logo:<br>
<img width="190" src="https://i.imgur.com/1J34pdS.png[/img]">

Mono:<br>
<i>(You have permission to recolour this to black if required)</i>:<br>
<img width="190" src="https://i.imgur.com/jrKo6LF.png[/img]">

We also ask that you kindly add the following text to your README documentation;
```
Vinifera is an unofficial open-source community collaboration project for preservation,
modding and compatibility purposes. Vinifera has no direct affiliation with Electronic
Arts Inc. and/or Command & Conquer. Command & Conquer is an Electronic Arts Inc. brand.
All Rights Reserved.

For more information on the Vinifera project and to download the latest builds,
please visit: http://vinifera-developers.github.io/
```
